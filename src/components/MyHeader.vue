     ...
     <div class="full-divider border-b border-slate-300 lg:px-12">
        ...
        <div class="full-divider full-divider border-b border-slate-300 lg:px-12">
            <nav class="nav-list w-full h-12  flex justify-between items-center">
                <div class="relative">
                    <ul class="hidden lg:flex w-auto h-auto flex" >
                    ...
                    <div :class="[open ? 'left-0' : '-left-80']" class=" duration-500 flex flex-col items-center rounded w-60 h-auto bg-white z-50 absolute lg:hidden left-0 top-12">
